...
class ShadowHandCameraEnvCfg(ShadowHandEnvCfg):
    ...
    # env
    num_channels = 3
    num_observations = 157#num_channels * tiled_camera.height * tiled_camera.width #+ 157

    

class ShadowHandRGBCameraEnv(ShadowHandEnv):
    ...
    def _get_observations(self) -> dict:
        ...
        img = camera_data.permute(0, 3, 1, 2)
        save_image(make_grid(img, nrow = 2), f'sh_export_{self.idx}.png')
        self.idx += 1
