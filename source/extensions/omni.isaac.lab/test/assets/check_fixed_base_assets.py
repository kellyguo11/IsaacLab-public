...
.. code-block:: bash
    ...
    # Usage
    ./isaaclab.sh -p source/extensions/omni.isaac.lab/test/assets/check_fixed_base_assets.py
...
# Pre-defined configs
##
from omni.isaac.lab_assets import ANYMAL_C_CFG, FRANKA_PANDA_CFG  # isort:skip
