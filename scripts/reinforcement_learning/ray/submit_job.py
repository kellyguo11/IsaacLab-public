...
.. code-block:: bash
    ...
    ./isaaclab.sh -p scripts/reinforcement_learning/ray/submit_job.py --aggregate_jobs wrap_resources.py --sub_jobs ./isaaclab.sh -p scripts/reinforcement_learning/rl_games/train.py --task Isaac-Cartpole-v0 --headless+./isaaclab.sh -p scripts/reinforcement_learning/rl_games/train.py --task Isaac-Cartpole-RGB-Camera-Direct-v0 --headless --enable_cameras agent.params.config.max_epochs=150

    # For all command line arguments
    ./isaaclab.sh -p scripts/reinforcement_learning/ray/submit_job.py -h
"""
