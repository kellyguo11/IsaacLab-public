...
import scripts.reinforcement_learning.ray.util as util
...
.. code-block:: bash
    ...
    ./isaaclab.sh -p scripts/reinforcement_learning/ray/launch.py -h

    # Examples

    # The following creates 8 GPUx1 nvidia l4 workers
    ./isaaclab.sh -p scripts/reinforcement_learning/ray/launch.py --cluster_host google_cloud \
