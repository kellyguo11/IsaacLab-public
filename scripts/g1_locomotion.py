...
class G1RoughDemo:
    ...
    * ESC: exit current third-person view"""
    ...
    def __init__(self):
        ...
        checkpoint = os.path.join(os.path.dirname(__file__), "model_1499_g1.pt") #get_published_pretrained_checkpoint(RL_LIBRARY, TASK)
        # create envionrment
        ...
        # env_cfg.commands.base_velocity.ranges.heading = (-0.5, 0.5)
    ...
    def set_up_keyboard(self):
        ...
        self._key_to_control = {
            ...
            "LEFT": torch.tensor([T, 0.0, R, 0.0], device=self.device),
            "RIGHT": torch.tensor([T, 0.0, -R, 0.0], device=self.device),
...
def main():
    ...
    while simulation_app.is_running():
        ...
        with torch.inference_mode():
            ...
            obs[:, 9:12] = demo_g1.commands[:, :3]
            # print(demo_g1.commands)
            # print(obs[:, 9:12])
